...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { arrival: @calendar.arrival, departure: @calendar.departure, house_id: @calendar.house_id }
    end
  ...
  test "should update calendar" do
    patch :update, id: @calendar, calendar: { arrival: @calendar.arrival, departure: @calendar.departure, house_id: @calendar.house_id }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
